...
```{r read-pa-data}
pa_path <- here::here("DATA/StP_testing_PA")
pa_data <- read_pa(here::here("DATA/StP_testing_PA/Outdoor"), "US/Pacific")
...
```{r read-reg-data}
reg_path <- here::here("data/StP_testing_REG")
reg_data <- read_reg(here::here("data/StP_testing_REG"), timezoneval = "US/Pacific",
