...
```{r read-pa-data}
pa_path <- here("DATA/StP_testing_PA")
pa_data <- read_pa(here("DATA/StP_testing_PA/Outdoor"), "US/Pacific")
...
```{r read-reg-data}
reg_path <- here("DATA/StP_testing_REG")
reg_data <- read_reg(here("DATA/StP_testing_REG"), timezoneval = "US/Pacific",
...
plot_CV_corr(cv_data, "NPH_PM25", "cvpreds_model_3", "Model 3")
```
